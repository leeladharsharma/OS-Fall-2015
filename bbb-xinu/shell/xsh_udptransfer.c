/* xsh_udptransfer.c - xsh_udptransfer */
...
/*------------------------------------------------------------------------
 * xsh_udptransfer - shell command that can send a message to Linux
 *	         and receive a reply
 *------------------------------------------------------------------------
 */
shellcmd xsh_udptransfer(int nargs, char *args[])
{
